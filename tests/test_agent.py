...
class AgentGraphTests(unittest.TestCase):
    ...
    def test_thread_follow_up_forecast_uses_langgraph_and_memory(self):
        ...
        self.assertIn(second["evidence"]["forecast"]["forecast_backend"], {"statsforecast", "manual_trend"})
        self.assertIn(second["evidence"]["forecast"]["model_name"], {"AutoETS", "rule_based"})
